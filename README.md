...
```
$ cd compose
$ docker-compose -f docker-compose-postgres-mock.yaml up
```
...
```
$ cd compose
$ docker-compose -f docker-compose-postgres-collect.yaml up
```

Using Clickhouse (see next section):
```
$ cd compose
$ docker-compose -f docker-compose-clickhouse-collect.yaml up
```
